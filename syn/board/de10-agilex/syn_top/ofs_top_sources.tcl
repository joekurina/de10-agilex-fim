...
set_global_assignment -name IP_SEARCH_PATHS "$::env(QUARTUS_ROOTDIR)/../ip/altera/emif/**/*;$::env(QUARTUS_ROOTDIR)/../ip/altera/subsystems/mem_ss/**/*;$::env(QUARTUS_ROOTDIR)/../ip/altera/intel_pcie/ptile/**/*;$::env(QUARTUS_ROOTDIR)/../ip/altera/subsystems/pcie_ss/**/*"
...
# DE10 Agilex HSSI: 8x25GbE via QSFP-DD Port A (E-Tile)
...
# Note: DE10 Agilex does not have PMCI, HPS, or UART
...
# Note: No pmci_top.sdc since DE10 doesn't have PMCI
